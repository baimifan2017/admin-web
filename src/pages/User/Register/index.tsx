        ...
        >
          <ProFormGroup label="个人信息">
            ...
            <IProFormText
              ...
              required
            />
            <IProFormText name="address" initialValue={get(entity, 'address')} label="联系地址" />
            <IProFormDigit
              label="年龄"
              name="age"
          ...
          <ProFormGroup label="支付信息">
            <IProFormText name="idNumber" label="身份证号" rules={[requiredProps]} />
            <IProFormText name="bankAccountName" label="银行户名称" rules={[requiredProps]} />
            <IProFormText name="bankAccountNumber" label="银行卡号" rules={[requiredProps]} />
          </ProFormGroup>
